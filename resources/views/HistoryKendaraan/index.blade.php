            ...
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="#" class="nav__link">
                        ...
                        <span class="nav__name">Profil Kendaraan</span>
                    </a>
                    ...
                    <a href="#" class="nav__link">
                        ...
                        <span class="nav__name">Data User</span>
                    </a>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2><b>Data Kendaraan</b></h2></div>
                    <div class="col-sm-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        @foreach ($posts as $historykendaraan)x
